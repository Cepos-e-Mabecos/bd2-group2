...
endpointName = "tiposrefeicao"
idTeste = "vAXxfT8m0Q"
infoTeste = {"cod_tiporefeicao": "vAXxfT8m0Q", "designacao": "Outro"}
...
def test_case3_post():
    ...
    data = {"designacao": "Tipos Refeicao Teste"}
...
def test_case4_put():
    ...
    data = {"designacao": "Tipos Refeicao Teste PUT"}
